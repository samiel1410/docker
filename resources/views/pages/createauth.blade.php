        ...
        <div class="absolute bottom-0 pl-20 m-20 sm:rounded-lg">
            <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                <div id="profile" class="rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                    <!--Main Col-->
                    <form method="GET" action="{{ route('createauth') }}">
                        {{ csrf_field() }}
                        <div class="bg-white px-10 py-8 rounded-xl w-screen shadow-md max-w-sm">
                            <div class="space-y-4">
                                <h1 class="text-center text-2xl font-semibold text-gray-600">Nuevo Autor</h1>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="bg-indigo-50 px-4 py-2 outline-none rounded-md w-full" name="fecha_nacimiento"/>
                                </div>
